...
const endpointOfertasGet =
  "https://lizard2.vercel.app/api/oferta";
const endpointAdmisionesGet =
  "https://lizard2.vercel.app/api/admision";

const endpointSignUpUser =
  "https://lizard2.vercel.app/api/auth/signup";

const endpointSignInUser =
  "https://lizard2.vercel.app/api/auth/signin";

const endpointProfesoresGet =
  "https://lizard2.vercel.app/api/profesores";
...
const responseDataOfertaGet = [
  ...
  },
  {
    ...
    admisiones: ["ENE - ABR 2024", "MAY- AGO 2024"],
    profesores: [
      {
        nombre: "Juanchis",
        apellidos: "Alcachofa"
...
const responseDataAdmisionesGet = [
  {
    ...
    ofertasEducativas: ["Automatización"]
  },
  {
