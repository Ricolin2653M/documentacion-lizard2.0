...
// Endpoints
const endpointOfertasGet = "https://lizard2.vercel.app/api/oferta";
const endpointAdmisionesGet = "https://lizard2.vercel.app/api/admision";
...
const endpointProfesorObtener =
  "https://lizard2.vercel.app/api/profesores/:profesorId";
const endpointObtenerAdmisionPorId =
  "https://lizard2.vercel.app/api/admision/:admisionId";
const endpointOfertaPorId =
  "https://lizard2.vercel.app/api/oferta/:ofertaId";
...
const cuerpoRelacionarOfertaYProfesores = [
  {
    ...
    "ofertasEducativas": ["6691c134288500ad483ac785"]
  }
  ,
];
    ...
    <section className="relative">
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="pt-32 pb-12 md:pt-40 md:pb-20">
          ...
          {/* Bloque Admision - Relacionar admisión con ofertas educativas */}
          <div className="bg-blue p-8 rounded-lg shadow-md">
            <h2 className="text-3xl font-bold text-center mb-4">
              Relacionar una Admisión con varias ofertas educativas
            </h2>
            <p className="text-center text-gray-600 mb-4">
              Con el siguiente endpoint puedes asignar, editar y eliminar ofertas educativas a una admisión
            </p>
            <div className="bg-gray-600 p-4 rounded-md shadow-md mb-4">
              <p className="text-center">
                <a
                  href={endpointAdmisionOfertas}
                  className="text-blue-500 font-bold no-underline"
                >
                  {endpointAdmisionOfertas}
                </a>
              </p>
            </div>
            <p className="text-center text-gray-600 mb-4">
            ...
            <div>
              <div className="bg-gray-600 p-4 rounded-md shadow-md">
                <pre className="overflow-x-auto">
                  {JSON.stringify(cuerpoRelacionarAdmisionYOfertas, null, 2)}
                </pre>
              </div>
            </div>
            <div className="inline-flex text-sm font-semibold py-1 px-3 m-2 text-green-600 bg-green-200 rounded-full mb-4">
            ...
            <div>
              <div className="bg-gray-600 p-4 rounded-md shadow-md">
                <pre className="overflow-x-auto">
                  {JSON.stringify(responseMensajeAltaRelacionAdmisionYOferta, null, 2)}
                </pre>
              </div>
            </div>
          </div>
          ...
          <div className="bg-blue p-8 rounded-lg shadow-md">
            ...
            <p className="text-center text-gray-600 mb-4">
              Con el siguiente endpoint puedes dar de alta una división
            </p>
            <div className="bg-gray-600 p-4 rounded-md shadow-md mb-4">
              <p className="text-center">
                <a
                  href={endpointDivisiones}
                  className="text-blue-500 font-bold no-underline"
                >
                  {endpointDivisiones}
                </a>
            ...
            <div>
              <div className="bg-gray-600 p-4 rounded-md shadow-md">
                <pre className="overflow-x-auto">
                  {JSON.stringify(cuerpoRelacionarDivisionesYOfertas, null, 2)}
                </pre>
              </div>
            </div>
            <div className="inline-flex text-sm font-semibold py-1 px-3 m-2 text-green-600 bg-green-200 rounded-full mb-4">
            ...
            <div>
              <div className="bg-gray-600 p-4 rounded-md shadow-md">
                <pre className="overflow-x-auto">
                  {JSON.stringify(responseMensajeAltaRelacionDivisionesYOfertas, null, 2)}
                </pre>
              </div>
            </div>
          </div>
